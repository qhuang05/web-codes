...
MagicZoom.prototype.initPopup = function() {
    ...
    this.pup.className = 'MagicZoomPup ty--border-color';
...
MagicZoom.prototype.initZoom = function(diyTop) {
    ...
    this.bigImageCont.style.top = diyTop ? diyTop : 0;
...
function MagicZoom_findZooms(diyTop) {
    ...
    for (var i = 0; i < aels.length; i++) {
        if (/MagicZoom/.test(aels[i].className)) {
            ...
            bigCont.style.top = diyTop ? diyTop : 0;
            var position = 'right';
            if (matches) {
                switch (matches[3]) {
                case 'left':
            ...
            bigCont.className = "MagicZoomBigImageCont ty--border-color";
            bigCont.style.zIndex = 99999;

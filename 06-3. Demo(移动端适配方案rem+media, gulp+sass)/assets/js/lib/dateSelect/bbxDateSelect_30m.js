...
var bbxDatePicker = {
    run: function(){
        ...
        $('li.time input').val('现在出发 ' + this.doubleNumber(curTime.getHours()) + ':' + this.doubleNumber(curTime.getMinutes())).attr('data-value', this.formatDate(curTime, 'yyyy-MM-dd HH:mm:ss'));
        //选择出发日期
        var _this = this;
